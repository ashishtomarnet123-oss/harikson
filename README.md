...
- Establishes an SSH connection to the Ace Cloud VM (`34.131.237.79`), pulls the fresh code, generates random environment secrets, runs migrations, triggers model downloads, and restarts containers.
