 ...
 * Detects speech start and speech end events with configurable hangover (default 700ms).
 *
...
export class VADController {
  constructor(options = {}) {
    this.options = {
      ...
      speechHangoverMs: 2000,          // Time to wait after speech drops below threshold (2000ms natural speaking pause)
