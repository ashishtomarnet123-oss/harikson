...
function PromptLibrarySettings() {
  ...
  if (loading)
    return <div className="settings-loading">Loading prompt library...</div>;
  ...
  return (
    <>
      <div className="settings-page-header">
        ...
        <p>
          Build and configure custom AI agents and specialized system prompts.
        </p>
      </div>
...
function RagDriveSettings() {
  ...
  if (loading)
    return <div className="settings-loading">Loading RAG Drive...</div>;
  ...
  return (
    <>
      <div className="settings-page-header">
        <h1>My RAG Drive</h1>
        <p>
          Upload files to index them and use them as persistent context in your
          chats. Files are saved to your account.
        </p>
      </div>
        ...
        >
          {uploading ? (
            ...
            <>
              ...
              >
                Attach PDF, TXT, CSV, or Image (PNG/JPG)
              </p>
              <input
                type="file"
                id="rag-upload"
      ...
      <div className="settings-section">
        ...
        {files.length === 0 ? (
          <p style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>
            No documents indexed in your library.
          </p>
        ) : (
          <div className="settings-flex-col">
            {files.map((f) => (
              <div
                key={f.id}
                className="settings-card settings-flex-row"
                style={{
                  display: 'flex',
                  justifyContent: 'space-between',
                  alignItems: 'center',
